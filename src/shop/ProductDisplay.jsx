...
const ProductDisplay = ({item}) => {
    const {name, id, img, price, seller, ratingsCount} = item;
    ...
    const handleSubmit = (e) => {
        ...
        const exisitingProductIndex = existingCart.findIndex(item => item.id === id);

        if(exisitingProductIndex !== -1) {
            existingCart[exisitingProductIndex].quantity += prequantity
        } else {
